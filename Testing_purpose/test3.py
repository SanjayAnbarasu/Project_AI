# Original: def apply_discount(cart_total, discount_percent:
def apply_discount(cart_total, discount_percent):
    # Original: discount_amount = cart_total * discount_percent
...
# Original: print(f"Payment processed successfully! Amount charged: ${checkout_price}
